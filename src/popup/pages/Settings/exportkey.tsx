                ...
                <Content style={{backgroundColor: '#1C1919'}}>
                    <div className="flex flex-col items-center mx-auto mt-5 gap-3_75 justify-evenly w-95">
                        ...
                        <div className='flex items-center w-full p-5 mt-1_25 h-15_5 box default'>
                            <Input className='font-bold text-white p0' bordered={false} status="error" placeholder="Export Key"/>
                        </div>
                        <Button size='large' type='primary' className='box w380' onClick={e => {navigate('/settings/show-key')}}>
