    ...
    <Layout className="h-full">
      ...
      <Content style={{ backgroundColor: '#1C1919' }}>
        <div className="flex flex-col items-center mx-auto mt-5 text-center gap-3_75 justify-evenly w-95">
          ...
          <div>{/* margin */} </div>
          <div className="p-5 font-semibold select-text box default text-4_5 w380 leading-6_5">glare knee able beach success comic giant aerobic myself false debris attack</div>
        </div>
      </Content>
