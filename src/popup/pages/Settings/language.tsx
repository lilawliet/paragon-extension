        ...
        <div className="flex flex-col items-center mx-auto mt-5 gap-3_75 justify-evenly w-95">
          ...
          >
            <div className="flex items-center justify-between text-base font-semibold">
              <div className="flex-grow text-left">English</div>
          ...
          >
            <div className="flex items-center justify-between text-base font-semibold">
              <div className="flex-grow text-left">Chinese</div>
          ...
          >
            <div className="flex items-center justify-between text-base font-semibold">
              <div className="flex-grow text-left">Japanese</div>
          ...
          >
            <div className="flex items-center justify-between text-base font-semibold">
              <div className="flex-grow text-left">Spanish</div>
